# Solar Cathedral artwork

All character illustrations, scenery and gallery artwork were created for this theme with OpenAI's built-in image generation tool on 2026-09-26. They depict an original character and fictional architecture. No third-party character artwork or external image source was used. Theme assets are offered under CC0-1.0.

The seven semantic control glyphs were independently drawn as a coherent angular line family and rasterized to transparent 96 × 96 PNG. Their original directions are explicit in the manifest.

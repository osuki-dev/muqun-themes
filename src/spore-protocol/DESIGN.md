...
Hollow porcelain forms and glowing mycelium create an imagined alien macro-world. Ultraviolet shadows contrast with chartreuse threads; pale lavender ceramic surfaces carry the light interface. Rounded branching back, seed-shaped send and tendril-loop attachment glyphs echo the organic structures.

Independent wide and portrait compositions keep detail near the edges. A contained seed-pod illustration decorates empty states. The default Muqun home identity remains. Both UI and terminal planes use 96% opacity.

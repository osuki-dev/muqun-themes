...
CLI 1.8.0 contrast passed: interface floors light 88%, dark 89%; terminal floors light 85%, dark 76%. The authored 96% opacity exceeds all floors.

Artwork, the two-mode preview and transparent illustration were visually inspected. Template icons were reviewed at 17px and 34px on both mode surfaces. Browser and native-device rendering remain unverified.

## Cultural references

Research only; no source images were reused.

- https://art-culture.cmu.ac.th/en/Museum
- https://www.arc.cmu.ac.th/dept/?dept=LANNA.ARCH&lang=en

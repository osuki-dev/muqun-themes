...
Germany / Dessau: an original modernist architectural screenprint collection. Concrete-white planes and graphite grids carry vermilion circles and signal-yellow squares. Dark mode uses a yellow action color against neutral graphite, keeping the collection distinct from its ink and cobalt themes.

...
Violet streetwear, turquoise headphones, and delicate electronics-district watercolor. Wordless foreground art, separate quiet architecture, and restrained midnight light.
...
Light mode disables ambient effects. Dark mode uses bloom at intensity 0.1 and speed 0.35. Effects are nonessential; the static composition remains complete when reduced motion disables them.
